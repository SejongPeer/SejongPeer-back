...
public class MemberController {
	...
	public AccountCheckResponse checkAccount(
		...
		@Pattern(
			...
			message = "최소 4자, 최대 24자 영문과 숫자로만 이루어져야합니다.") String account) {
		if (memberService.isAccountExists(account)) {
	...
	public NicknameCheckResponse checkNickname(
		...
		@Pattern(
			...
			message = "닉네임은 2자 이상 8자 이하 한글, 영어, 숫자만 입력해주세요.") String nickname) {

...
public record StudyPostInfoNoLoginResponse(
	String title,
	String writerMajor,
	...
	public static StudyPostInfoNoLoginResponse fromStudy(Study study, String categoryName, int scrapCount) {
		return new StudyPostInfoNoLoginResponse(
			study.getTitle(),
